...
export const projects = [
  ...
  {
    id: 7,
    name: 'Care pulse Nextjs',
    description: 'Users can easily book, reschedule, and cancel appointments with a few taps. ',
    stack: ['Appwrite', 'Next.js', 'Tailwindcss', 'Git & Github', 'Vercel deploy'],
    image:'./images/care-pulse.png',
    url: 'https://careplus-nextjs.vercel.app/',
    repoLink: 'https://github.com/ostricnano/careplus-nextjs',
  },
  {
    id: 8,
    name: 'Car show case nextjs',
    description: 'A simple car showcase website made with Next',
    stack: [ 'Next.js', 'Tailwindcss', 'Git & Github', 'Vercel deploy'],
    image:'./images/car-show-case.png',
